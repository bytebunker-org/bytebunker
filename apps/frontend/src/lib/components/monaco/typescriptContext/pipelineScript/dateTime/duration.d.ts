...
declare interface DurationLikeObject extends DurationObjectUnits {
...
declare type DurationUnit = keyof DurationLikeObject;
declare type DurationUnits = DurationUnit | DurationUnit[];

declare type ToISOFormat = 'basic' | 'extended';

declare interface ToISOTimeDurationOptions {
	/**
...
declare interface ToHumanDurationOptions extends Intl.NumberFormatOptions {
 ...
 */
declare type DurationInput = Duration | number | DurationLikeObject;

/**
 * Either a Luxon Duration, a number of milliseconds, the object argument to Duration.fromObject()
 */
declare type DurationLike = Duration | DurationLikeObject | number;

declare type DurationMaybeValid = CanBeInvalid extends true
 ...
 */
declare class Duration<IsValid extends boolean = DefaultValidity> {
	/**
