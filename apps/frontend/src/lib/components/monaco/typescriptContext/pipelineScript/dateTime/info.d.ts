...
declare interface InfoUnitOptions extends InfoOptions {
	numberingSystem?: NumberingSystem | undefined;
}

/** @deprecated */
declare type UnitOptions = InfoUnitOptions;

declare interface InfoCalendarOptions extends InfoUnitOptions {
	/**
	 * @default gregory
	 */
