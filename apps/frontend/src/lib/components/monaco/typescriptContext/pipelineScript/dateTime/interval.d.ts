declare interface IntervalObject {
...
declare type IntervalMaybeValid = CanBeInvalid extends true
	? Interval<Valid> | Interval<Invalid>
	: Interval;

declare type CountOptions = _UseLocaleWeekOption;
 ...
 */
declare class Interval<IsValid extends boolean = DefaultValidity> {
	/**
