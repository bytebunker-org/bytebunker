declare interface ZoneOffsetOptions {
	/**
 ...
 */
declare type ZoneOffsetFormat = 'narrow' | 'short' | 'techie';

declare type ZoneMaybeValid = CanBeInvalid extends true ? Zone<true> | Zone<false> : Zone;

declare abstract class Zone<IsValid extends boolean = DefaultValidity> {
	/**
	 * The type of zone
	 */
 ...
 */
declare class IANAZone<IsValid extends boolean = DefaultValidity> extends Zone<IsValid> {
	/**
 ...
 */
declare class FixedOffsetZone extends Zone<true> {
	/**
 ...
 */
declare class InvalidZone extends Zone<false> {
	get type(): 'invalid';
 ...
 */
declare class SystemZone extends Zone<true> {
	/**
