...
declare type ASStringFallback = string & { __type: 'unknown-type' };
declare type ASTypeWithFallback<S extends string> = S | ASStringFallback;
 ...
 * Union Types
 */
declare type ObjectOrLink = ASObject | ASLink;
declare type ImageOrLink = Image | ASLink;
declare type CollectionOrLink = Collection | ASLink;
declare type CollectionPageOrLink = CollectionPage | ASLink;
declare type CollectionPageOrCollectionPageLink = CollectionPage | ASLink; // Corrected union name
declare type ObjectOrLinkOrOrderedItems = ObjectOrLink | OrderedItems;
declare type ImageOrLinkOrThing = Image | ASLink | OwlThing; // Thing from owl:Thing, assuming it's a basic type if needed
declare type LinkOrThing = ASLink | OwlThing; // Thing from owl:Thing
declare type LangStringOrString = string; // rdf:langString or xsd:string
 ...
 */
declare interface Relationship extends ASObject {
	'@type': 'Relationship';
 ...
 */
declare interface Tombstone extends ASObject {
	'@type': 'Tombstone';
 ...
 */
declare interface Profile extends ASObject {
	'@type': 'Profile';
 ...
 */
declare interface Collection extends ASObject {
 ...
 */
declare interface CollectionPage extends Collection {
 ...
 */
declare interface OrderedCollectionPage extends OrderedCollection, CollectionPage {
 ...
 */
declare interface OrderedCollection extends Collection {
 ...
 */
declare interface OrderedItems extends Array<ObjectOrLink> {
 ...
 */
declare interface Mention extends ASLink {
	'@type': 'Mention';
}
 ...
 */
declare interface Document extends ASObject {
 ...
 */
declare interface Audio extends Document {
	'@type': 'Audio';
}
 ...
 */
declare interface Image extends Document {
	'@type': 'Image';
}
 ...
 */
declare interface Video extends Document {
	'@type': 'Video';
}
 ...
 */
declare interface Page extends ASObject {
	'@type': 'Page';
}
 ...
 */
declare interface Article extends ASObject {
	'@type': 'Article';
}
 ...
 */
declare interface Note extends ASObject {
	'@type': 'Note';
}
 ...
 */
declare interface Place extends ASObject {
	'@type': 'Place';
 ...
 */
declare interface Event extends ASObject {
	'@type': 'Event';
 ...
 */
declare interface Group extends ASObject {
	'@type': 'Group';
}
 ...
 */
declare interface Organization extends ASObject {
	'@type': 'Organization';
}
 ...
 */
declare interface Person extends ASObject {
	'@type': 'Person';
}
 ...
 */
declare interface Application extends ASObject {
	'@type': 'Application';
}
 ...
 */
declare interface Service extends ASObject {
	'@type': 'Service';
}

declare type ASObjectType = ASTypeWithFallback<
	| 'Object'
	| 'Activity'
...
declare type ActivityType = ASTypeWithFallback<
	| 'Activity'
	| 'IntransitiveActivity'
	| 'Accept'
	| 'TentativeAccept'
 ...
 */
declare interface ASActivity extends ASObject {
	'@type': ActivityType;
 ...
 */
declare interface IntransitiveActivity extends ASActivity {
 ...
 */
declare interface Accept extends ASActivity {
 ...
 */
declare interface TentativeAccept extends Accept {
 ...
 */
declare interface Add extends ASActivity {
	'@type': 'Add';
}
 ...
 */
declare interface Announce extends ASActivity {
	'@type': 'Announce';
}
 ...
 */
declare interface Arrive extends IntransitiveActivity {
	'@type': 'Arrive';
}
 ...
 */
declare interface Ignore extends ASActivity {
	'@type': 'Ignore' | 'Block';
}
 ...
 */
declare interface Block extends Ignore {
	'@type': 'Block';
}
 ...
 */
declare interface Create extends ASActivity {
	'@type': 'Create';
}
 ...
 */
declare interface Delete extends ASActivity {
	'@type': 'Delete';
}
 ...
 */
declare interface Dislike extends ASActivity {
	'@type': 'Dislike';
}
 ...
 */
declare interface Follow extends ASActivity {
	'@type': 'Follow';
}
 ...
 */
declare interface Flag extends ASActivity {
	'@type': 'Flag';
}
 ...
 */
declare interface Invite extends Offer {
	'@type': 'Invite';
}
 ...
 */
declare interface Join extends ASActivity {
	'@type': 'Join';
}
 ...
 */
declare interface Leave extends ASActivity {
	'@type': 'Leave';
}
 ...
 */
declare interface Like extends ASActivity {
	'@type': 'Like';
}
 ...
 */
declare interface Listen extends ASActivity {
	'@type': 'Listen';
}
 ...
 */
declare interface Move extends ASActivity {
	'@type': 'Move';
	/**
	 * For certain activities, specifies the entity from which the action is directed.
	 * @see https://www.w3.org/ns/activitystreams#origin
 ...
 */
declare interface Offer extends ASActivity {
	'@type': 'Offer' | 'Invite';
}
 ...
 */
declare interface Question extends IntransitiveActivity {
	'@type': 'Question';
 ...
 */
declare interface Read extends ASActivity {
	'@type': 'Read';
}
 ...
 */
declare interface Reject extends ASActivity {
 ...
 */
declare interface TentativeReject extends Reject {
 ...
 */
declare interface Remove extends ASActivity {
	'@type': 'Remove';
}
 ...
 */
declare interface Travel extends IntransitiveActivity {
	'@type': 'Travel';
 ...
 */
declare interface Undo extends ASActivity {
	'@type': 'Undo';
}
 ...
 */
declare interface Update extends ASActivity {
	'@type': 'Update';
}
 ...
 */
declare interface View extends ASActivity {
	'@type': 'View';
}
