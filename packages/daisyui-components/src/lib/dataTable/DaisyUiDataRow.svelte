<script lang="ts">
    ...
    import DaisyUiBadgeWrapper from '$lib/dataTable/DaisyUiBadgeWrapper.svelte';
    import DaisyUiIconWrapper from '$lib/dataTable/DaisyUiIconWrapper.svelte';
    import { InternalDataColumn, InternalDataRow } from 'svelte-advanced-datatable/internal';
    import type { FullDataTableConfig } from 'svelte-advanced-datatable';
    import { DATATABLE_CONFIG } from 'svelte-advanced-datatable';
    ...
    export let onClick: (<T>(item: T) => void | Promise<void>) | undefined;
